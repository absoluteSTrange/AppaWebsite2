...
<!--
      <div class="hero-banner">
          <div class="container">
              <div class="row">
                  <div class="col-md-5">
                      <h1 class="h1 h1-repsonsive">BBC Universal Exports<br> Globally, Local</h1>
                      <p class="p p-responsive">International trading simplified through strategic partnerships</p>
                      <button class="btn-theme-2 btn">Learn More</button>
                  </div>
                  <div class="col-md-5">
                    <div class="">
                        <img src="Images/Image1.jpg" alt="" class="img-fluid hero-image">
                    </div>
                </div>
              </div>
